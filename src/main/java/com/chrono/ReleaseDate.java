...
public enum ReleaseDate {
    ...
    _28_JANUARY_2001("28 January 2001",new GregorianCalendar(2001, Calendar.FEBRUARY, 28).getTime()),
    ...
    _24_MAY_2001("24 May 2001",new GregorianCalendar(2001, Calendar.MAY, 24).getTime()),
    ...
    _25_MARCH_2002("March 2002", new GregorianCalendar(2002, Calendar.MARCH, 31).getTime()),
    _9_APRIL_2002("9 April 2002", new GregorianCalendar(2002, Calendar.MARCH, 31).getTime()),
    _30_APRIL_2002("30 April 2002", new GregorianCalendar(2002, Calendar.APRIL, 30).getTime()),
    _10_MAY_2002("10 May 2002", new GregorianCalendar(2002, Calendar.MAY, 31).getTime()),
    _28_MAY_2002("28 May 2002", new GregorianCalendar(2002, Calendar.MAY, 31).getTime()),
    ...
    _17_MARCH_2003("17 March 2003", new GregorianCalendar(2003, Calendar.MARCH, 17).getTime()),
    ...
    _24_AUGUST_2004("24 August 2004", new GregorianCalendar(2004, Calendar.AUGUST, 30).getTime()),
